...
export function PillarChips({ pillars, actions }: { pillars: Pillar[]; actions: ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="mt-6 min-h-44 max-w-3xl sm:min-h-36" aria-live="polite">
        <p
          className={`text-xl font-light italic leading-relaxed text-white drop-shadow-lg transition-opacity duration-200 motion-reduce:transition-none sm:text-2xl ${
